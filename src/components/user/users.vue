<template>
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="9"
          ><el-input placeholder="请输入内容" v-model="queryInfo.query" clearable @clear="getUserList"> <el-button @click="getUserList" slot="append" icon="el-icon-search"> </el-button> </el-input
        ></el-col>
        <el-col :span="4">
    ...
    <el-table :data="userlist" border stripe>
      ...
      <el-table-column label="状态">
        <template v-slot="scope">
          <!-- 插槽，拿到数据源中当前行的数据 {{scope.row}} 可找到mg_state-->
          <!--开关的状态与数据的状态相关联  -->
